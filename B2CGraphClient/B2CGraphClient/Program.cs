...
namespace B2CGraphShell
{
    ...
    {
        private static string tenantId = ConfigurationManager.AppSettings["b2c:TenantId"];
        private static string tenantName = ConfigurationManager.AppSettings["b2c:TenantName"];
        ...
        static void Main(string[] args)
        {
            ...
            client = new B2CGraphClient(clientId, clientSecret, tenantId, tenantName);
            ...
            try
            {
                switch (args[0].ToUpper())
                {
                    ...
                    case "UPDATE-USER": UpdateUser(args);
                        break;
                    case "ADD-MEMBER": AddMember(args);
                        break;
        ...
        private static void AddMember(string[] args)
        {
            if (args.Length <= 1)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Please include both user and group object IDs.  Run B2CGraphShell Syntax to see examples.");
                Console.ForegroundColor = init;
                return;
            }
            ...
            object formatted = JsonConvert.DeserializeObject(client.AddMember(userId, groupId).Result);
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine(JsonConvert.SerializeObject(formatted, Formatting.Indented));
        }
        ...
        private static void PrintSyntax(string[] args)
        {
            ...
            Console.WriteLine("Add-Member                   : B2C Add-Member UserId GroupId");
            Console.WriteLine("                             : B2C Add-Member abdcefgh-abcd-abcd-abcdefghijk 12345678-1234-1234-123456789012");
        ...
        private static void PrintHelp(string[] args)
        {
            ...
            Console.WriteLine("Add-Member                   : Add an user from your B2C directory to an AD Group. Requires the user object Id and the group object Id.");
